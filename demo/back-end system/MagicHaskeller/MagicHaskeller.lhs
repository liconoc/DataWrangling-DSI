...
module MagicHaskeller(
       ...
       --   'mkPG' and 'setPG' used to be called @mkMemo@ and @setMemo@ respectively (because the main ingredient of a program generator is a memoization table). というコメントはそぐわなくなってきたので止める．
...
{- x 念のためやってみたけど，やっぱダメやね．てゆーか，Recompのままやって各深さで見る手はあるかも．
